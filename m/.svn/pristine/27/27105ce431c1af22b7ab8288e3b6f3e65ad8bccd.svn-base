...
namespace BoardHunt.m
{
    public partial class surfboardsforsale : System.Web.UI.Page
    {
        ...
        protected const int iPageCountLimit = 10;
        protected const int iRowsListCount = 10;
        ...
        private void ItemsGet()
        {
            ...
            //ErrorLog.ErrorRoutine(false, "strSQLPre: " + strSQL);
            ...
            try
            {
                ...
                //if (cboViewVal == "All" || listCount <= Convert.ToInt32(cboViewVal))
                if (listCount <= iRowsListCount)
                {
            ...
            {
                ErrorLog.ErrorRoutine(false, "SFS:ItemGet():Error Msg: " + ex.Message);
        ...
        public string cboViewVal
        {
            get
            {
                ...
                if (o == null)
                    return (iRowsListCount.ToString());   // default to showing "all"
                else
                    return o.ToString();
            }
        ...
        */
        ...
        private void BuildPageLinks(int pgCount)
        {
            ...
            for (int i = iStart; i < iEnd; i++)
            {
                ...
                lnkButton.CssClass = "grey_grey22";
                //lnkButton.Style["padding-right"] = "10px";

                if (CurrentPage == i)
                {
                    lnkButton.ForeColor = Color.White;
                    lnkButton.BackColor = Color.Orange;
                    lnkButton.BorderWidth = 1;
                    lnkButton.BorderColor = Color.OrangeRed;
                }
            ...
            //if (pgCount - CurrentPage > 10) //show window starting at current page
            //{
            //    for (int i = CurrentPage; i < pgCount; i++)
            //    {
            //        LinkButton lnkButton = new LinkButton();
            //        lnkButton.Text = "&nbsp;" + Convert.ToInt32(i + 1).ToString() + "&nbsp;";
            //        lnkButton.OnClientClick = ("javascript:__doPostBack('pageLnkButton','" + i + "');event.returnValue=false;return false;");
        ...
        */
        ...
        private void GetSetQueryStrings()
        {
            ...
            //VIEWCOUNT:cboViewVal          15 is the default
            ...
            {
                cboViewVal = iRowsListCount.ToString();
            }
