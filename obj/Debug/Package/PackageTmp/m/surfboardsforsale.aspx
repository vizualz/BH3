...
<body>
    ...
    <div id="main" align="center">
        ...
        <div align="center">
                            <%--FILTER--%>
                            <div id="left" style="margin_top: 30px; margin_bottom: 30px;">

                                                            <asp:Panel runat="server" Width="" ID="pnlSimple" BorderStyle="solid" BorderColor="#99CC33"
                                    BorderWidth="0">
                                    <table border="0" bgcolor="#ffffff" cellpadding="0" cellspacing="0" style="background-color: #99CC33; width: 950px">
                                    <tr>
                                     <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td align="center" style="background-color: #99CC33" style="width: 200px">
                                                <asp:Button ID="btnSearch2" Text="Hunt" align="center" runat="server" CssClass="black40b" Width="140px"
                                                    OnClick="btnSearch_Click" />
                                            </td>

                                            <td>
                                                &nbsp;&nbsp;<asp:TextBox ID="txtFilterKwd" runat="server" Width="200" CssClass="dkrgrey30b"
                                            ...
                                            Width="150px"></asp:TextBox>  --%>&nbsp;&nbsp;
                                                   ...
                                                   <td >
                                                &nbsp;&nbsp;<asp:DropDownList ID="cboBoardType" Width="200" runat="server" CssClass="dkrgrey30b">
                                                </asp:DropDownList>&nbsp;&nbsp;
                                            </td>
                                            <td >
                                                &nbsp;&nbsp;<asp:DropDownList ID="cboLocation" Width="200" runat="server" CssClass="dkrgrey30b">
                                                </asp:DropDownList>&nbsp;&nbsp;
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" align="left" class="dkrgrey30b" style="width: 300px">
                                                &nbsp;$
                                                <asp:TextBox ID="txtMinPrice" OnClick="select()" runat="server" Width="70" Text="Min"
                                                    CssClass="dkrgrey30b"></asp:TextBox>
                                                &nbsp;to&nbsp;
                                                <asp:TextBox ID="txtMaxPrice" OnClick="select()" CssClass="dkrgrey30b" runat="server"
                                                    Text="Max" Width="70"></asp:TextBox>
                                            </td>
                                            
                                            <td align="left" style="background-color: #99CC33; width: 300px; height: 20px;">
                                                <a href="javascript:resetFilter()" class="white_white30">reset</a>
                                            </td>
                                        </tr>
                                        <tr>
                                     <td>&nbsp;</td>
