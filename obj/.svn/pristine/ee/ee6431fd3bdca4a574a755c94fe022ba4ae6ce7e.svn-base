<%@ Page Language="C#" AutoEventWireup="true" Codebehind="Surfboards.aspx.cs"
    Inherits="BoardHunt.Shaper.Surfboards" %>
...
<%--                            <asp:Panel runat="server" ID="pnlProfile" Width="500" BorderColor="red" BorderWidth="0">
                            ...
                            <div align="right" style="width: 785px;" >
                            <div class="slct_box_latestmodel">
                                            <div class="btn_left">
                                            ...
                                            <div class="info_txt">
                                                Page</div>
                                            <asp:TextBox ID="toptxtCurrentPage" runat="server"  CssClass="option_box_shaper" ForeColor="White" AutoPostBack="True"
                        ...
                        <div align="right" style="width: 785px;" >
                           <div class="slct_box_latestmodel">
                                            <div class="btn_left">
                                           <%-- shaper_left_hover.png / shaper_left.png--%> 
                                                  <asp:ImageButton ID="cmdPrev"  onmouseover="this.src='../images/shaper_left_hover.png'"  onmouseout="this.src='../images/shaper_left.png'"
                                                        ImageUrl="~/images/shaper_left.png" runat="server"></asp:ImageButton>
                                            </div>
                                            <div class="info_txt">
                                                PAGE</div>
                                            <asp:TextBox ID="txtCurrentPage" runat="server" AutoPostBack="True" CssClass="option_box_shaper" ForeColor="White" Visible="false" OnTextChanged="txtCurrentPage_TextChanged"></asp:TextBox>
                                             <div class="info_txt">
