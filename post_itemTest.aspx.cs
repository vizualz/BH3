...
namespace BoardHunt
{
    ...
    public partial class post_itemTest : System.Web.UI.Page
    {
...
*/
        ...
        */
        ...
        private void btnNext_Click(object sender, System.EventArgs e)
        {
            ...
            //Goto preview_post
            Response.Redirect("preview_postTest.aspx", false);
        }
        ...
        private bool LoadForEdits(classes.BoardItem tempBoardItem)
        {
            ...
            if (tempBoardItem.AdType == (int)1 || tempBoardItem.AdType == (int)4)
            {
                ...
                img1.ImageUrl = img2.ImageUrl = img3.ImageUrl = img4.ImageUrl = string.Empty;
        ...
        */
        ...
        public bool CheckUploadedFiles(List<HttpPostedFile> lstUploadedFiles)
        {
            ...
            int count = lstUploadedFiles.Count; // uploadFilCol.Count;
        ...
        */
        private void btnBack_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("postTest.aspx?em=1", true);
            }
