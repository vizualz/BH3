...
{
    public partial class Surfboards : System.Web.UI.Page
    {
 ...
 */
        private void ItemsGet()
        {
            ...
            //=====
            strSQL = @"
                        SELECT bt.iValue, e.*, tblUser.userDir   
                          FROM tblEntry e 
                        INNER JOIN (
                                    SELECT iUser, Max(dCreateDate) AS RecentPost 
                                      FROM tblEntry  
                                     ...
                                     WHERE iUser IN(
                                                  ...
                                                  INNER JOIN tblServices s 
                                                       ...
                                                       WHERE u.iAcctType = 2 
                                                         ...
                                                         AND u.iMerchantType = 1 
 
                                                         AND s.iServiceVal = 3 
                                                         AND s.iStatus = 1
                                                      )
                                    AND iUser <> 433 AND iUser <> 2061
                                    GROUP BY iUser
                        )
                        SHAPERS on e.iuser = shapers.iUser AND e.dCreateDate = shapers.RecentPost";
            strSQL += @" INNER JOIN LK_BoardType bt
                        ON bt.iD = e.iBoardType";
            strSQL += @" INNER JOIN tblUser 
						ON tblUser.iD = e.iUser";
            ...
            try
            {
                ...
                if (listCount <= (int)15)
                {
                    ...
                    //HidePaging(); // Change By Smarttech
                    ShowPaging();
                }
                else
                {
 ...
 */
        ...
        */
        ...
        private void BuildPageLinks(int pgCount)
        {
            ...
            ////clear out any old ones if we're posting back   //Change By Smarttech
            ...
            for (int i = 0; i < pgCount; i++)
            {
                ...
                //placeHolder.Controls.Add(lnkButton);   //Change By Smarttech
            }
        }
        /*
        */
