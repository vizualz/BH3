...
if (navigator.plugins != null && navigator.plugins.length > 0)
 {
     if (navigator.plugins["Shockwave Flash 2.0"] || navigator.plugins["Shockwave Flash"]) 
     {
         ...
         var tempArrayMajor = descArray[2].split("."); var versionMajor = tempArrayMajor[0]; var versionMinor = tempArrayMajor[1];
    ...
    else 
    {
        if ($.browser.msie)
        {
            ...
            catch (e) { } flashVer = version.replace("WIN ", "").replace(",", ".")
        }
    }
