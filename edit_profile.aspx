            ...
            <div align="center" style="width: 400px"> <!--- TODO: add breadcrumb style -->
                ...
                &nbsp;&gt;&nbsp;MY ACCOUNT INFO</span>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Panel role="tabpanel" runat="server" id="pnlRegister" class="admin-form tab-pane active col-lg-6 col-md-8 col-sm-9 col-xs-12" server style="float: none; margin: 0 auto;">
                            ...
                            <div class="panel-body p15 pt10">                                           
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                       <div class="col-md-6 col-sm-6 col-xs-6 pn mb10 text-right">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 pn mb10 text-left">
                                            <asp:RadioButtonList ID="rdoImgMgr1" runat="server" CssClass="dkrgrey14" OnClick="rdoClick('1')"
                                            TabIndex="17">
                                ...
                                <div class="section row">
                                    <div clAss="col-md-12 col-sm-12 col-xs-12">
                                        <span class="dkgrey14" height="5px" align="right" nowrap style="width: 200px">
                                        Full name:</span>                                      
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <span class="dkgrey14" height="5px" align="right" nowrap>
                                        Display name:&nbsp;</span>
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                            <span class="dkgrey14" height="5px" align="right">
                                            E-mail:&nbsp;</span>
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtEmail"
                                                Font-Bold="True" ErrorMessage="!" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                            <span class="dkgrey14" align="right" height="5px">
                                            Phone #:&nbsp;</span>                                      
                                            ...
                                            <asp:CustomValidator ID="Customvalidator2" runat="server" Font-Bold="True" ErrorMessage="!"
                                                OnServerValidate="CheckPhoneNum"></asp:CustomValidator>
                                    </div>
                                </div>
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">                                      
                                            <span class="dkrgrey10b" style="height: 20px">
                                            <asp:CheckBox ID="chkShowPhone" runat="server" Text="&nbsp;Allow buyers to see my phone #"></asp:CheckBox></span                                    
                                            <span class="dkgrey18b" style="height: 40px;" align="left" valign="top" colspan="2">
                                    </div>
                                </div> 
...
<!---SETTINGS -->
                    <div class="panel panel-warning heading-border">
                        ...
                        <div class="panel-body p15 pt10">
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">                                                        
                                            <span class="dkgrey14" valign="middle" height="5px" align="right">
                                            Is this a business?&nbsp;</span>                                                                                  
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">     
                                            <span class="dkgrey14" valign="middle" height="5px" align="right" nowrap>
                                            Email me when people &nbsp;<br />
                                            write on my wall:&nbsp;</span>
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">      
                                            ...
                                            <asp:Button ID="btnChangePwd" runat="server" class="dkrgrey14" Text="Change Password..."
