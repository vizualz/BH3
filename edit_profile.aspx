                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <asp:Panel role="tabpanel" runat="server" id="pnlRegister" class="admin-form tab-pane active col-lg-6 col-md-8 col-sm-9 col-xs-12" server style="float: none; margin: 0 auto;">
                            ...
                            <div class="panel-body p15 pt10">                                           
                                ...
                                <div class="section row">
	                                <div class="col-md-12 col-sm-12 col-xs-12">
		                                <div class="col-md-12 col-sm-12 col-xs-12 pn mb10 text-left">
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 pn mb10 text-right">
                                ...
                                <div class="section row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-12 col-sm-12 col-xs-12 pn mb10 text-left">
                                            ...
                                            <asp:CheckBox ID="chkShowPhone" runat="server" Text=" Show buyers my phone#"></asp:CheckBox></span>
                                        </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12 pn mb10 text-right">
