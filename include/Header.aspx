...
<div style="text-align: center; margin: 0px">
    ...
    <div align="center" style="background-color: #222222">
        <div align="right" style="border: solid 0px red; margin-right: 50px; width: 996px" class="white14">
            ...
            &nbsp<asp:linkbutton id="lnkUpgradeAcct" cssclass="orange_ltgreen12u" runat="server" visible="false">Upgrade</asp:linkbutton>
            <%--|
        ...
        <%--COLOR SPACER--%>
        <div style="background-color: #444444; height: 2px;">
            <img src="http://www.boardhunt.com/images/s1x1.gif" alt="spacer" /></div>
                ...
                <ul class="sf-menu">
                    ...
                    <li style="width: 180px">
                        ...
                        <ul style="display: none">
                            ...
                            <li><a href="/Surfboardsforsale.aspx?iCat=1&bt=8">&nbsp;Fun Shape & Eggs</a></li>
                            <li><a href="/Surfboardsforsale.aspx?iCat=1&bt=32">&nbsp;Hybrid</a></li>
                            <li><a href="/Surfboardsforsale.aspx?iCat=1&bt=16">&nbsp;Gun</a></li>
                            <li><a href="/Surfboardsforsale.aspx?iCat=1&bt=64">&nbsp;Standup Paddle</a></li>
